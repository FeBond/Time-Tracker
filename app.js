...
class TimeTracker {
    ...
    initializeApp() {
        ...
        document.getElementById('add-period').addEventListener('click', () => this.addTimePeriod());
        ...
        document.getElementById('filter-past-week').addEventListener('click', () => this.filterPastWeek());
        document.getElementById('toggle-entries').addEventListener('click', () => this.toggleEntriesSection());
        ...
        document.getElementById('start-stopwatch').addEventListener('click', () => this.startStopwatch());
        document.getElementById('pause-stopwatch').addEventListener('click', () => this.pauseStopwatch());
        document.getElementById('stop-stopwatch').addEventListener('click', () => this.stopStopwatch());
